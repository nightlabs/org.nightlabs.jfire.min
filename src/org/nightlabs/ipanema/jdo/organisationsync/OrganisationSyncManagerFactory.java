...
import org.nightlabs.ipanema.jdo.cache.LocalDirtyListener;
import org.nightlabs.ipanema.jdo.organisationsync.IncomingChangeListenerDescriptor;
import org.nightlabs.ipanema.jdo.organisationsync.OutgoingChangeListenerDescriptor;
import org.nightlabs.ipanema.jdo.organisationsync.SyncContext;
import org.nightlabs.ipanema.jdo.organisationsync.id.SyncContextID;
...
public class OrganisationSyncManagerFactory implements Serializable
{
	...
	public static final String JNDI_PREFIX = "java:/ipanema/organisationSyncManagerFactory/";
			...
			throws NamingException, DirtyObjectIDBufferException
	{
		...
		try {
			ctx.createSubcontext("java:/ipanema/organisationSyncManagerFactory");
		} catch (NameAlreadyBoundException e) {
			// ignore
		}
