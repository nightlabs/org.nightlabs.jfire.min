 ...
 */
package org.nightlabs.ipanema.datastoreinit;
...
import org.nightlabs.ipanema.datastoreinit.xml.DatastoreInitMan;
import org.nightlabs.ipanema.datastoreinit.xml.Dependency;
import org.nightlabs.ipanema.datastoreinit.xml.Init;
...
public class DatastoreInitializer
{
	...
	public DatastoreInitializer(File ipanemaModuleBaseDir)
	{
		// Scan all JARs within all EARs for datastoreinit.xml files.
		File[] ears = ipanemaModuleBaseDir.listFiles(earFileFilter);
