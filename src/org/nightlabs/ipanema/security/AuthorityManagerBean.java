...
import org.nightlabs.ipanema.security.AuthorityNotFoundException;
import org.nightlabs.ipanema.security.AuthoritySearchResult;
import org.nightlabs.ipanema.security.RoleGroup;
import org.nightlabs.ipanema.security.RoleGroupRef;
import org.nightlabs.ipanema.security.RoleGroupRefNotFoundException;
import org.nightlabs.ipanema.security.RoleGroupRefSearchResult;
...
import org.nightlabs.ipanema.security.UserRefNotFoundException;
import org.nightlabs.ipanema.security.UserRefSearchResult;
...
/**
 * @ejb.bean name="ipanema/ejb/JFireBaseBean/AuthorityManager"
 *	jndi-name="ipanema/ejb/JFireBaseBean/AuthorityManager"
 *	type="Stateless"
 *
...
//				result.makeTransient(includeMask);
	...
	//				}
					...
					ism.ipanemaSecurity_flushCache();
				} finally {
					if (CLOSE_PM) pm.close();
				}
			} finally {
...
//				roleGroupRef.makeTransient(includeMask);
	...
	//				pm.getExtent(Authority.class, true);
					...
					ism.ipanemaSecurity_flushCache(userID);
				} finally {
					if (CLOSE_PM) pm.close();
				}
			} finally {
