...
{
	protected static final String QUEUE_INVOCATION = "queue/ipanema/JFireBaseBean/AsyncInvokerInvocationQueue";
	protected static final String QUEUE_SUCCESSCALLBACK = "queue/ipanema/JFireBaseBean/AsyncInvokerSuccessCallbackQueue";
	protected static final String QUEUE_ERRORCALLBACK = "queue/ipanema/JFireBaseBean/AsyncInvokerErrorCallbackQueue";
	protected static final String QUEUE_UNDELIVERABLECALLBACK = "queue/ipanema/JFireBaseBean/AsyncInvokerUndeliverableCallbackQueue";
	...
	throws JMSException, NamingException, LoginException
	{
		...
		LoginContext loginContext = new LoginContext("ipanemaLocal", mqCallbackHandler);
		loginContext.login();
		try {		
