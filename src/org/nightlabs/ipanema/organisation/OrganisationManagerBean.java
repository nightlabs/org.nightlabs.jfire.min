...
import org.nightlabs.ipanema.server.id.ServerID;
...
import org.nightlabs.ipanema.servermanager.config.RootOrganisationCf;
import org.nightlabs.ipanema.servermanager.config.ServerCf;

import org.nightlabs.ModuleException;
import org.nightlabs.ipanema.organisation.OrganisationManager;
import org.nightlabs.ipanema.organisation.OrganisationManagerUtil;
import org.nightlabs.ipanema.security.UserManager;
import org.nightlabs.ipanema.security.UserManagerHome;
 ...
 *
 * @ejb.bean
 *		name="ipanema/ejb/JFireBaseBean/OrganisationManager"
 *		jndi-name="ipanema/ejb/JFireBaseBean/OrganisationManager"
 *		type="Stateless"
 *
...
//	}
	 ...
	 * @ejb.permission role-name="_Guest_"
	 *
	 * @see org.nightlabs.ipanema.servermanager.JFireServerManagerFactory#isOrganisationCfsEmpty()
	 */
...
//			}
	...
	throws ModuleException
	{
		...
		try {
			...
			beginRegistration(
					"org.jnp.interfaces.NamingContextFactory", // TODO this should come from a config - maybe an anonymousInitialContextFactory in org.nightlabs.ipanema.servermanager.config.J2eeServerTypeRegistryConfigModule - see Lookup.getInitialContextProperties(...)
