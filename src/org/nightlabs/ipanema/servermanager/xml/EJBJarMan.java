...
public class EJBJarMan implements Serializable
{
	...
	protected String ipanemaModuleName;
	public String getJFireModuleName() {
		return ipanemaModuleName;
	}
	
	public EJBJarMan(String _ipanemaModuleName)
	{
		this.ipanemaModuleName = _ipanemaModuleName;
	}
	...
	public EJBJarMan(String _ipanemaModuleName, InputStream ejbJarIn)
