...
public class VendorAdapterJBoss implements VendorAdapter
{
	...
	throws Exception
	{
		...
		Object[] params = { "ipanema" }; // String securityDomain
	...
	/**
	 * @see org.nightlabs.ipanema.servermanager.j2ee.VendorAdapter#registerNotificationListenerServerStarted(org.nightlabs.ipanema.servermanager.j2ee.ServerStartNotificationListener)
	 */
	...
	/**
	 * @see org.nightlabs.ipanema.servermanager.j2ee.VendorAdapter#getUserResolver()
	 */
