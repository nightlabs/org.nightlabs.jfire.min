...
{
	public static String QUEUECF_JNDI_LINKNAME = "java:/ipanema/system/QueueConnectionFactory";
	public static String TOPICCF_JNDI_LINKNAME = "java:/ipanema/system/TopicConnectionFactory";
