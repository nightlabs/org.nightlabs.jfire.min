...
import org.nightlabs.ipanema.language.LanguageManagerUtil;
...
public class LanguageWatcher implements LoginStateListener {
	...
	/**
	 * @see org.nightlabs.ipanema.base.login.LoginStateListener#loginStateChanged(int, org.eclipse.jface.action.IAction)
	 */
	...
	protected void syncLanguages() {
		org.nightlabs.ipanema.language.LanguageManager remoteLanguageManager = null;		
		try {
