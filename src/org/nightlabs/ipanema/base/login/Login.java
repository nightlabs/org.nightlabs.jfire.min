...
import org.nightlabs.ipanema.classloader.JFireRCLBackend;
import org.nightlabs.ipanema.classloader.JFireRCLBackendUtil;
import org.nightlabs.ipanema.classloader.JFireRCDLDelegate;
		...
		public void run() {
			...
			try {
				try{
					...
					loginContext = new JFireLoginContext("ipanema", new LoginCallbackHandler());
...
//		}
	...
	{
		return "org.nightlabs.ipanema.base.loginstatelistener";
	}
	...
	public static Login.AsyncLoginResult testLogin(JFireLoginContext loginContext) {
		...
		// verify login
		JFireRCLBackend ipanemaCLBackend = null;
//		LanguageManager languageManager = null;
		if (ipanemaCLBackend == null) {
			try {
				ipanemaCLBackend = JFireRCLBackendUtil.getHome(
