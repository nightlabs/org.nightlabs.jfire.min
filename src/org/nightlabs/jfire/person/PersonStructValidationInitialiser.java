...
public class PersonStructValidationInitialiser
{
	...
	throws StructBlockNotFoundException, StructFieldNotFoundException
	{
		...
		StructField<RegexDataField> emailStructField = (StructField<RegexDataField>) internetDataStructBlock.getStructField(PersonStruct.INTERNET_EMAIL);
		...
		ExpressionDataFieldValidator<RegexDataField, StructField<RegexDataField>> rexValidator =
			new ExpressionDataFieldValidator<RegexDataField, StructField<RegexDataField>>(rexDataFieldExpression, Messages.getString("org.nightlabs.jfire.person.PersonStruct.EmailValidationWarning"), ValidationResultType.WARNING, emailStructField);
