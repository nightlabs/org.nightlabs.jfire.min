 ...
 */
public class StructFieldKey {
	
	public StructFieldKey() {	}
	
	public StructFieldKey(String structFieldOrganisationID, String structFieldID) {
		this.structFieldOrganisationID = structFieldOrganisationID;
	...
	public String getPropStructFieldID() {
		return structFieldID;
	}
	public String getPropStructFieldOrganisationID() {
