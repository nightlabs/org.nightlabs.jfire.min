...
implements II18nTextDataField
{
	...
	public DataField cloneDataField(PropertySet propertySet) {
		NumberDataField newField = new NumberDataField(propertySet.getOrganisationID(), propertySet.getPropertySetID(), this);
	 ...
	 * Note, that this only is the actual value of the field if the number of digigs is 0.
