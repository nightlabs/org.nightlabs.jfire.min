...
extends ServerConfiguratorJBoss
{
	...
	/* (non-Javadoc)
	 * @see org.nightlabs.jfire.serverconfigurator.ServerConfiguratorJBoss#doConfigureServer()
	 */
	@Override
		...
		try {
			...
			if (!destFile.exists()) {
				...
				Utils.copyResource(
						...
						"jfire-jbossmq-mysql-jdbc-state-service.xml.jfire",
						destFile);
			}
