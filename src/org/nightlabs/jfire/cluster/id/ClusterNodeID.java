...
package org.nightlabs.jfire.cluster.id;
...
implements Serializable
{
	...
	/**
	 * Primary key field clusterNodeID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.cluster.ClusterNode}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.util.UUID clusterNodeID;

	/**
	 * Create a new empty instance of ClusterNodeID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	...
	/**
	 * Create a new instance of ClusterNodeID.
	 ...
	 * <code>ClusterNodeID newClusterNodeID = new ClusterNodeID(oldClusterNodeID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ClusterNodeID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends ClusterNodeID> clazz = this.getClass();
	...
	public String toString()
	{
		...
		try {
			sb.append("clusterNodeID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(clusterNodeID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		ClusterNodeID other = (ClusterNodeID) obj;
		if(clusterNodeID == null) {
			if(other.clusterNodeID != null)
				return false;
		} else if(!clusterNodeID.equals(other.clusterNodeID))
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		final int prime = 31;
		int result = 1;
		result = prime * result + ((clusterNodeID == null) ? 0 : clusterNodeID.hashCode());
		return result;
	}

	/**
	 * Create a new object id instance.
	 * @param clusterNodeID The primary key field clusterNodeID.
	 * @return a newly created instance of <code>ClusterNodeID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static ClusterNodeID create(UUID clusterNodeID)
	{
		ClusterNodeID n = new ClusterNodeID();
		n.clusterNodeID = clusterNodeID;
		return n;
	}
}
