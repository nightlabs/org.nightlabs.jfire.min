...
package org.nightlabs.jfire.asyncinvoke.id;
...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.asyncinvoke.InvocationError}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class InvocationErrorID
implements ObjectID
{
	/**
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -2431696158039783632L;
	...
	/**
	 * Primary key field asyncInvokeEnvelopeID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.asyncinvoke.InvocationError}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String asyncInvokeEnvelopeID;

	/**
	 * Primary key field errorID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.asyncinvoke.InvocationError}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public int errorID;
	...
	/**
	 * Create a new empty instance of InvocationErrorID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public InvocationErrorID()
	{
	}

	/**
	 * Create a new instance of InvocationErrorID.
	 ...
	 * <code>InvocationErrorID newInvocationErrorID = new InvocationErrorID(oldInvocationErrorID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public InvocationErrorID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends InvocationErrorID> clazz = this.getClass();
	...
	public String toString()
	{
		...
		try {
			sb.append("asyncInvokeEnvelopeID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(asyncInvokeEnvelopeID), ENCODING));
			sb.append('&');
			sb.append("errorID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Integer.toString(errorID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		InvocationErrorID other = (InvocationErrorID) obj;
		if(asyncInvokeEnvelopeID == null) {
			if(other.asyncInvokeEnvelopeID != null)
				return false;
		} else if(!asyncInvokeEnvelopeID.equals(other.asyncInvokeEnvelopeID))
			return false;
	 ...
	 * @param asyncInvokeEnvelopeID The primary key field asyncInvokeEnvelopeID.
	 * @param errorID The primary key field errorID.
	 * @return a newly created instance of <code>InvocationErrorID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static InvocationErrorID create(String asyncInvokeEnvelopeID, int errorID)
	{
		InvocationErrorID n = new InvocationErrorID();
		n.asyncInvokeEnvelopeID = asyncInvokeEnvelopeID;
		n.errorID = errorID;
		return n;
	}
}
