...
implements DataBlockEditorChangedListener 
{
	...
	public PersonPersonalDataWizardPage(String pageName, String title, Person person, String scope) {
		super(pageName, title, StructLocalDAO.sharedInstance().getStructLocal(Person.class, scope), person, PersonStruct.PERSONALDATA);
...
//		autoCreateDisplayNameGD.horizontalAlignment = GridData.FILL;
	...
	public void updatePerson() {
		...
		getProp().setDisplayName(displayName.getTextControl().getText(), StructLocalDAO.sharedInstance().getStructLocal(Person.class, structLocalScope));
	}
