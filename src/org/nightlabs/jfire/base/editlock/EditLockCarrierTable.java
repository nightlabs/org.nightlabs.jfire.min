...
extends AbstractTableComposite
{
	...
	protected void createTableColumns(TableViewer tableViewer, Table table)
	{
		...
		tc.setText(Messages.getString("org.nightlabs.jfire.base.editlock.EditLockCarrierTable.description")); //$NON-NLS-1$

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.base.editlock.EditLockCarrierTable.created")); //$NON-NLS-1$

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.base.editlock.EditLockCarrierTable.lastActivity")); //$NON-NLS-1$
