...
public class ShutdownAfterStartupManager
...
//	public synchronized boolean isActive(ShutdownControlHandle shutdownControlHandle)
//	{
//		return shutdownControlHandles.contains(shutdownControlHandle);
//	}

	public synchronized void shutdown(ShutdownControlHandle shutdownControlHandle)
	{
		if (!shutdownControlHandles.remove(shutdownControlHandle))
			throw new IllegalArgumentException("Unknown shutdownControlHandle: " + shutdownControlHandle);
