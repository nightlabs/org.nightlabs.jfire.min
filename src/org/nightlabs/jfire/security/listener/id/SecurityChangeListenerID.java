...
package org.nightlabs.jfire.security.listener.id;
...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.security.listener.SecurityChangeListener}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class SecurityChangeListenerID
implements ObjectID
{
	/**
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -1990813508L;
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.security.listener.SecurityChangeListener}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field securityChangeListenerID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.security.listener.SecurityChangeListener}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String securityChangeListenerID;

	/**
	 * Create a new empty instance of SecurityChangeListenerID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public SecurityChangeListenerID()
	{
	}

	/**
	 * Create a new instance of SecurityChangeListenerID.
	 ...
	 * <code>SecurityChangeListenerID newSecurityChangeListenerID = new SecurityChangeListenerID(oldSecurityChangeListenerID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public SecurityChangeListenerID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends SecurityChangeListenerID> clazz = this.getClass();
	 ...
	 * {@link #SecurityChangeListenerID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("securityChangeListenerID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(securityChangeListenerID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		SecurityChangeListenerID other = (SecurityChangeListenerID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(securityChangeListenerID == null) {
			if(other.securityChangeListenerID != null)
				return false;
		} else if(!securityChangeListenerID.equals(other.securityChangeListenerID))
			return false;
		return true;
	}
	 ...
	 * @param securityChangeListenerID The primary key field securityChangeListenerID.
	 * @return a newly created instance of <code>SecurityChangeListenerID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static SecurityChangeListenerID create(String organisationID, String securityChangeListenerID)
	{
		SecurityChangeListenerID n = new SecurityChangeListenerID();
		n.organisationID = organisationID;
		n.securityChangeListenerID = securityChangeListenerID;
		return n;
	}
}
