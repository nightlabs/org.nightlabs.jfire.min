...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.security.UserLocal}.
...
implements ObjectID, AuthorizedObjectID
{
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -283860164L;
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.security.UserLocal}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	...
	/**
	 * Primary key field localOrganisationID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.security.UserLocal}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String localOrganisationID;

	/**
	 * Create a new empty instance of UserLocalID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public UserLocalID()
	{
	...
	/**
	 * Create a new instance of UserLocalID.
	 ...
	 * <code>UserLocalID newUserLocalID = new UserLocalID(oldUserLocalID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public UserLocalID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends UserLocalID> clazz = this.getClass();
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("localOrganisationID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(localOrganisationID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		UserLocalID other = (UserLocalID) obj;
		...
		if(userID == null) {
			...
			return false;
		if(localOrganisationID == null) {
			if(other.localOrganisationID != null)
				return false;
		} else if(!localOrganisationID.equals(other.localOrganisationID))
			return false;
		return true;
	}
	 ...
	 * @param localOrganisationID The primary key field localOrganisationID.
	 * @return a newly created instance of <code>UserLocalID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static UserLocalID create(String organisationID, String userID, String localOrganisationID)
	{
		UserLocalID n = new UserLocalID();
		n.organisationID = organisationID;
		n.userID = userID;
		n.localOrganisationID = localOrganisationID;
		return n;
	}
