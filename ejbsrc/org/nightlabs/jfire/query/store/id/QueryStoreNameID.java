 ...
 * {@link org.nightlabs.jfire.query.store.QueryStoreName}.
 * <p>This class was auto-generated using XDoclet.
 */
public class QueryStoreNameID
implements Serializable, org.nightlabs.jdo.ObjectID
{
	private static final long serialVersionUID = -1269003231L;
	/**
	 ...
	 *
	 * See {@link org.nightlabs.jfire.query.store.QueryStoreName#organisationID}.
	 */
	public java.lang.String organisationID;
	/**
	 * Primary key field queryStoreID.
	 *
	 * See {@link org.nightlabs.jfire.query.store.QueryStoreName#queryStoreID}.
	 */
	public long queryStoreID;

	/**
	 * Create a new empty instance of QueryStoreNameID.
	 */
	public QueryStoreNameID()
	{
	}

	/**
	 * Create a new instance of QueryStoreNameID.
	 ...
	 * <code>QueryStoreNameID newQueryStoreNameID = new QueryStoreNameID(oldQueryStoreNameID.toString());</code>
	 *
	 ...
	 */
	public QueryStoreNameID(String keyStr)
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof QueryStoreNameID))
			return false;

		QueryStoreNameID other = (QueryStoreNameID)obj;
	 ...
	 *
	 * @param organisationID The primary key field organisationID. See {@link org.nightlabs.jfire.query.store.QueryStoreName#organisationID}.
	 * @param queryStoreID The primary key field queryStoreID. See {@link org.nightlabs.jfire.query.store.QueryStoreName#queryStoreID}.
	 * @return a newly created instance of <code>QueryStoreNameID</code>
	 *		with the primary-key fields set to the given parameters.
	 */
	public static QueryStoreNameID create(
				java.lang.String organisationID,
				long queryStoreID
		)
	{
		QueryStoreNameID n = new QueryStoreNameID();
