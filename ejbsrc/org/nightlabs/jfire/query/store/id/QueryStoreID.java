...
package org.nightlabs.jfire.query.store.id;
 ...
 * {@link org.nightlabs.jfire.query.store.AbstractQueryStore}.
 * <p>This class was auto-generated using XDoclet.
 */
public class QueryStoreID
implements Serializable, org.nightlabs.jdo.ObjectID
{
	private static final long serialVersionUID = -1988556908L;
	/**
	 ...
	 *
	 * See {@link org.nightlabs.jfire.query.store.AbstractQueryStore#organisationID}.
	 */
	public java.lang.String organisationID;
	/**
	 * Primary key field queryStoreID.
	 *
	 * See {@link org.nightlabs.jfire.query.store.AbstractQueryStore#queryStoreID}.
	 */
	public long queryStoreID;
	/**
	 * Primary key field ownerID.
	 *
	 * See {@link org.nightlabs.jfire.query.store.AbstractQueryStore#ownerID}.
	 */
	public java.lang.String ownerID;

	/**
	 * Create a new empty instance of QueryStoreID.
	 */
	public QueryStoreID()
	{
	}
	...
	/**
	 * Create a new instance of QueryStoreID.
	 ...
	 * <code>QueryStoreID newQueryStoreID = new QueryStoreID(oldQueryStoreID.toString());</code>
	 *
	 ...
	 */
	public QueryStoreID(String keyStr)
	...
	public String toString() {
		...
		try {
		 ...
		 sb.append('&');
		 sb.append("queryStoreID=");
		 sb.append(encodeFieldValue(queryStoreID));
		 sb.append('&');
		 sb.append("ownerID=");
		 sb.append(encodeFieldValue(ownerID));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof QueryStoreID))
			return false;

		QueryStoreID other = (QueryStoreID)obj;
		...
		return
					...
					&&
					this.queryStoreID == other.queryStoreID
					&&
					(
						(this.ownerID == other.ownerID) ||
						(this.ownerID != null && this.ownerID.equals(other.ownerID))
					)
			;
	}
	...
	public int hashCode()
	{
		return
					...
					^
					primitiveHashCode(queryStoreID)
					^
					(ownerID == null ? 0 : ownerID.hashCode()) // Normally, it should never be null, but still it just happened to me! Marco.
			;
	}
	 ...
	 *
	 * @param organisationID The primary key field organisationID. See {@link org.nightlabs.jfire.query.store.AbstractQueryStore#organisationID}.
	 * @param queryStoreID The primary key field queryStoreID. See {@link org.nightlabs.jfire.query.store.AbstractQueryStore#queryStoreID}.
	 * @param ownerID The primary key field ownerID. See {@link org.nightlabs.jfire.query.store.AbstractQueryStore#ownerID}.
	 * @return a newly created instance of <code>QueryStoreID</code>
	 *		with the primary-key fields set to the given parameters.
	 */
	public static QueryStoreID create(
				java.lang.String organisationID,
				long queryStoreID,
				java.lang.String ownerID
		)
	{
		QueryStoreID n = new QueryStoreID();
		n.organisationID = organisationID;
		n.queryStoreID = queryStoreID;
		n.ownerID = ownerID;
		return n;
	}
