...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.editlock.EditLock}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class EditLockID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.editlock.EditLock}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field editLockID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.editlock.EditLock}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public long editLockID;

	/**
	 * Create a new empty instance of EditLockID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public EditLockID()
	{
	...
	/**
	 * Create a new instance of EditLockID.
	 ...
	 * <code>EditLockID newEditLockID = new EditLockID(oldEditLockID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public EditLockID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends EditLockID> clazz = this.getClass();
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("editLockID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(editLockID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		EditLockID other = (EditLockID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(editLockID != other.editLockID)
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + (int) (editLockID ^ (editLockID >>> 32));
		return result;
	}
	 ...
	 * @param editLockID The primary key field editLockID.
	 * @return a newly created instance of <code>EditLockID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static EditLockID create(String organisationID, long editLockID)
	{
		EditLockID n = new EditLockID();
		n.organisationID = organisationID;
		n.editLockID = editLockID;
		return n;
	}
}
