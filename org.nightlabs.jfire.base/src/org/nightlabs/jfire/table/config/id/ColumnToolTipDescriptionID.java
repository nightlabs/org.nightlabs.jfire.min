...
package org.nightlabs.jfire.table.config.id;
...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.table.config.ColumnToolTipDescription}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class ColumnToolTipDescriptionID
implements Serializable
{
	 ...
	 */ 
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -1788936866L;
	...
	/**
	 * Primary key field columnDescriptorID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.table.config.ColumnToolTipDescription}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public long columnDescriptorID;
	...
	/**
	 * Create a new empty instance of ColumnToolTipDescriptionID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ColumnToolTipDescriptionID()
	{
	}

	/**
	 * Create a new instance of ColumnToolTipDescriptionID.
	 ...
	 * <code>ColumnToolTipDescriptionID newColumnToolTipDescriptionID = new ColumnToolTipDescriptionID(oldColumnToolTipDescriptionID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ColumnToolTipDescriptionID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends ColumnToolTipDescriptionID> clazz = this.getClass();
	 ...
	 * {@link #ColumnToolTipDescriptionID(String)}.
	...
	public String toString() 
	{
		...
		try {
			sb.append("columnDescriptorID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(columnDescriptorID, RADIX), ENCODING));
			sb.append('&');
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		ColumnToolTipDescriptionID other = (ColumnToolTipDescriptionID) obj;
		if(columnDescriptorID != other.columnDescriptorID)
			return false;
	...
	public int hashCode()
	{
		final int prime = 31;
		int result = 1;
		result = prime * result + (int) (columnDescriptorID ^ (columnDescriptorID >>> 32));
	 ...
	 * @param columnDescriptorID The primary key field columnDescriptorID.
	 * @param organisationID The primary key field organisationID.
	 * @return a newly created instance of <code>ColumnToolTipDescriptionID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static ColumnToolTipDescriptionID create(long columnDescriptorID, String organisationID)
	{
		ColumnToolTipDescriptionID n = new ColumnToolTipDescriptionID();
		n.columnDescriptorID = columnDescriptorID;
