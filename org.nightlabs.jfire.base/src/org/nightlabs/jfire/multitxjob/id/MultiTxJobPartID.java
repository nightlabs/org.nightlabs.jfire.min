...
package org.nightlabs.jfire.multitxjob.id;
...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.multitxjob.MultiTxJobPart}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class MultiTxJobPartID
implements ObjectID
{
	/**
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = 7133282281894636487L;
	...
	/**
	 * Primary key field multiTxJobID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.multitxjob.MultiTxJobPart}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String multiTxJobID;

	/**
	 * Primary key field multiTxJobPartID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.multitxjob.MultiTxJobPart}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public long multiTxJobPartID;

	/**
	 * Create a new empty instance of MultiTxJobPartID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public MultiTxJobPartID()
	{
	}

	/**
	 * Create a new instance of MultiTxJobPartID.
	 ...
	 * <code>MultiTxJobPartID newMultiTxJobPartID = new MultiTxJobPartID(oldMultiTxJobPartID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public MultiTxJobPartID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends MultiTxJobPartID> clazz = this.getClass();
	...
	public String toString()
	{
		...
		try {
			sb.append("multiTxJobID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(multiTxJobID), ENCODING));
			sb.append('&');
			sb.append("multiTxJobPartID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(multiTxJobPartID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		MultiTxJobPartID other = (MultiTxJobPartID) obj;
		if(multiTxJobID == null) {
			if(other.multiTxJobID != null)
				return false;
		} else if(!multiTxJobID.equals(other.multiTxJobID))
			return false;
		if(multiTxJobPartID != other.multiTxJobPartID)
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		final int prime = 31;
		int result = 1;
		result = prime * result + ((multiTxJobID == null) ? 0 : multiTxJobID.hashCode());
		result = prime * result + (int) (multiTxJobPartID ^ (multiTxJobPartID >>> 32));
		return result;
	}

	/**
	 * Create a new object id instance.
	 * @param multiTxJobID The primary key field multiTxJobID.
	 * @param multiTxJobPartID The primary key field multiTxJobPartID.
	 * @return a newly created instance of <code>MultiTxJobPartID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static MultiTxJobPartID create(String multiTxJobID, long multiTxJobPartID)
	{
		MultiTxJobPartID n = new MultiTxJobPartID();
		n.multiTxJobID = multiTxJobID;
		n.multiTxJobPartID = multiTxJobPartID;
		return n;
	}
}
