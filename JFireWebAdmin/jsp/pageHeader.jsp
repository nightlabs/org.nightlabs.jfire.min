...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="StyleSheet" href="css/jfire.css" type="text/css"/>
	...
	<body>
		<div class="pagehead" style="border-top: 1px solid #dddddd; border-bottom: 1px solid #dddddd; margin-bottom: 30px;">
			<img src="img/jfire-logo.jpg" />
		</div>

		<div id="waitblock" style="display: none; padding: 32px;">
			<img id="waitblockimage" src="/jfire/images/loading.gif"/>
		...
		<div class="page" style="background-image:url(img/jfire-grey.gif); background-position:right top; background-repeat:no-repeat; padding-bottom: 60px">
