...
public class ServerConfigurationException extends Exception
{
  ...
  /**
   * Constructs a new ServerConfigurationException with the specified detail message.  The
  ...
  /**
   * Constructs a new ServerConfigurationException with the specified cause and a detail
  ...
  /**
   * Constructs a new ServerConfigurationException with the specified detail message and
